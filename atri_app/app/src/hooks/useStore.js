...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Image16": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/what%20i%20can%20do%20for%20you.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image26": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Applications%20im%20flient%20in.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image30": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/what%20you%20can%20expect.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image34": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Product%20Design.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image38": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Joggr%20Website%20Design.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image42": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/GorillaX%20Branding.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image46": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/greater-than.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image80": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/doblue%20qt.svg"
      },
      "callbacks": {
        "onClick": [
          {
